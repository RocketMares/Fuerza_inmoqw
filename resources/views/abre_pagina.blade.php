...
<html lang="en">
  <head>
    ...
    <title>Curso Laravel Bluweb!</title>
  </head>
  <body>
...
<div class="container mt-5 my-5">
    ...
    <a href="{{ route('home') }}" class="btn btn-primary">Inicia registro de sesion</a>
...
<div class="footer bg-dark text-white text-center p-5 ">footer</div>
